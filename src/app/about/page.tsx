    ...
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <section className="mt-10">
        ...
        <div className="mt-4 space-y-4">
          <div className="rounded-lg border border-purple-200 p-5">
      ...
      <section className="mt-10">
        ...
        <div className="mt-4 rounded-lg bg-purple-50 p-6">
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            <span className="rounded-full bg-purple-50 px-3 py-1 text-xs text-gray-500 border border-purple-200">
              Enterprise IT
            </span>
            <span className="rounded-full bg-purple-50 px-3 py-1 text-xs text-gray-500 border border-purple-200">
              Global SaaS
      ...
      <div className="mt-12 text-center">
        <Link
          href="/"
          className="inline-block rounded-lg bg-purple-600 px-6 py-3 text-sm font-medium text-gray-900 hover:bg-purple-700"
        >
