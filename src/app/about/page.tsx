...
export default function AboutPage() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
      <h1 className="text-3xl font-bold text-white">About SaaS Atlas</h1>
      ...
      <section className="mt-10">
        ...
        <div className="mt-4 space-y-4">
          <div className="rounded-lg border border-purple-900/30 p-5">
      ...
      <section className="mt-10">
        <h2 className="text-2xl font-bold text-white">About the Author</h2>
        <div className="mt-4 rounded-lg bg-[#1a1530] p-6">
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            <span className="rounded-full bg-[#1a1530] px-3 py-1 text-xs text-gray-400 border border-purple-900/30">
              Enterprise IT
            </span>
            <span className="rounded-full bg-[#1a1530] px-3 py-1 text-xs text-gray-400 border border-purple-900/30">
              Global SaaS
      ...
      <div className="mt-12 text-center">
        <Link
          href="/"
          className="inline-block rounded-lg bg-purple-600 px-6 py-3 text-sm font-medium text-white hover:bg-purple-700"
        >
